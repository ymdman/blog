...
/** アバウトページ [See type definition](https://app.contentful.com/spaces/eocxbw5apjo8/content_types/about) */
export type AboutProfileArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};


/** アバウトページ [See type definition](https://app.contentful.com/spaces/eocxbw5apjo8/content_types/about) */
export type AboutSiteArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};


/** アバウトページ [See type definition](https://app.contentful.com/spaces/eocxbw5apjo8/content_types/about) */
export type AboutTestArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};
...
export type AboutFilter = {
  ...
  profile_exists?: InputMaybe<Scalars['Boolean']['input']>;
  profile_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  profile_not?: InputMaybe<Scalars['String']['input']>;
  profile_not_contains?: InputMaybe<Scalars['String']['input']>;
  profile_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  ...
  test_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  test_not?: InputMaybe<Scalars['String']['input']>;
  test_not_contains?: InputMaybe<Scalars['String']['input']>;
  test_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};
...
export type BlogPostCategoryCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<BlogPostCategoryCollectionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
export enum BlogPostCategoryCollectionOrder {
  NameAsc = 'name_ASC',
  NameDesc = 'name_DESC',
  SlugAsc = 'slug_ASC',
  SlugDesc = 'slug_DESC',
...
export type AboutQuery = { __typename?: 'Query', about?: { __typename?: 'About', profile?: string | null, site?: string | null } | null };

export type BlogPostQueryVariables = Exact<{ [key: string]: never; }>;


export type BlogPostQuery = { __typename?: 'Query', blogPost?: { __typename?: 'BlogPost', title?: string | null, content?: string | null } | null };

export type BlogPostCollectionQueryVariables = Exact<{ [key: string]: never; }>;


export type BlogPostCollectionQuery = { __typename?: 'Query', blogPostCollection?: { __typename?: 'BlogPostCollection', total: number, items: Array<{ __typename?: 'BlogPost', title?: string | null, sys: { __typename?: 'Sys', id: string } } | null> } | null };


export const AboutDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"About"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"about"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"StringValue","value":"1Q0Koa4MU3p52jL5yKvYOE","block":false}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"profile"}},{"kind":"Field","name":{"kind":"Name","value":"site"}}]}}]}}]} as unknown as DocumentNode<AboutQuery, AboutQueryVariables>;
export const BlogPostDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"BlogPost"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"blogPost"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"StringValue","value":"","block":false}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"content"}}]}}]}}]} as unknown as DocumentNode<BlogPostQuery, BlogPostQueryVariables>;
export const BlogPostCollectionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"BlogPostCollection"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"blogPostCollection"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total"}},{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"sys"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]}}]} as unknown as DocumentNode<BlogPostCollectionQuery, BlogPostCollectionQueryVariables>;